...
export default defineConfig({
  testDir: './tests', testMatch: ['align.spec.ts', 'chop-picker.spec.ts', 'sample-editor.spec.ts', 'pages.spec.ts', 'launch.spec.ts', 'followup.spec.ts', 'combined.spec.ts', 'native-recording.spec.ts', 'recording-performance.spec.ts'], workers: 1, timeout: 60_000,
