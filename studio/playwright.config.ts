...
export default defineConfig({
  testDir: './tests', testMatch: ['pages.spec.ts', 'launch.spec.ts', 'followup.spec.ts', 'combined.spec.ts', 'native-recording.spec.ts', 'recording-performance.spec.ts'], workers: 1, timeout: 60_000,
